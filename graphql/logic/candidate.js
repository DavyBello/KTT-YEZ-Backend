const createAndUpdateCandidate = exports.createAndUpdateCandidate = (field, TC) => TC.get('$createOne').wrapResolve(next => async (rp) => {
...
const updateCandidateRelationshipField = exports.updateCandidateRelationshipField = (field, TC) => TC.get('$updateById').wrapResolve(next => async (rp) => {
  // get contextCandidate from resolveParams (rp)
...
const updateCandidate = exports.updateCandidate = TC => TC.get('$updateById').wrapResolve(next => async (rp) => {
  // get contextCandidate from resolveParams (rp)
  const { contextCandidate, args } = rp;
